            ...
            <div class="d-flex flex-column gap-5 gap-xl-11">
                ...
                <div class="row gap-4 gap-lg-0">
                    <div class="col-lg-4">
                        <h2 class="fs-13 mb-0" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
                            Play Better, Game Smarter with Memo
                        </h2>
                    </div>
                    <div class="col-lg-8">
                        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                            <p class="fs-5 mb-6">
                                Memo is a high-performance gaming accessories brand designed to enhance speed, comfort, and precision for mobile gamers.
                                Through Gadgetnio, Memo’s lineup of cooling fans, finger sleeves, gamepads, and various gaming gear is now available across Indonesia—
                                delivering pro-level performance for casual players and competitive gamers alike.
                            </p>

                            <h4>1. Engineered for Competitive Gaming</h4>
                            <p class="fs-5 mb-6">
                                From ultra-fast cooling fans that prevent overheating to high-sensitivity finger sleeves and responsive gamepads,
                                Memo creates accessories that elevate accuracy, stability, and gameplay comfort.
                                Each product is built to give gamers the edge they need in every match.
                            </p>

                            <h4>2. Reliable Distribution, Authentic Quality</h4>
                            <p class="fs-5 mb-0">
                                Supported by Gadgetnio’s nationwide distribution network, Memo products reach retailers and gamers quickly and reliably—
                                ensuring authentic quality, ready stock availability, and dependable after-sales support across Indonesia.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 mb-7" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                        <img src="../assets/images/portfolio/memo-product-1.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                        <img src="../assets/images/portfolio/memo-product-2.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                        <img src="../assets/images/portfolio/memo-product-3.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
