        ...
        <div class="container position-relative z-2">
            <div class="d-flex flex-column gap-4 pb-5 pb-xl-10">
                ...
                <div class="d-flex align-items-end gap-3" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                    <h1 class="mb-0 fs-15 fs-md-16 text-white lh-1">THINKPLUS</h1>
                    <a href="https://www.thinkplusaudio.id/" class="p-1 ps-7 bg-primary rounded-pill">
            ...
            <div class="d-flex flex-column gap-5 gap-xl-11">
                    ...
                    <div class="d-md-flex align-items-center gap-4 gap-lg-8" data-aos="fade-up" data-aos-delay="200"
                        ...
                        <div class="d-flex flex-column gap-2 py-2">
                            ...
                            <p class="mb-0 fs-5 fw-medium">
                                <a href="https://www.thinkplusaudio.id/" target="_blank" class="text-dark text-decoration-none link-hover">
                                    thinkplusaudio.id
                                </a>
                            </p>
                        </div>
                ...
                <div class="row">
                    <div class="col-12 mb-7" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                        <img src="../assets/images/portfolio/thinkplus-product-1.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                        <img src="../assets/images/portfolio/thinkplus-product-2.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                        <img src="../assets/images/portfolio/thinkplus-product-3.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
