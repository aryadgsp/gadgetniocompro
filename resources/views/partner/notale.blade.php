            ...
            <div class="d-flex flex-column gap-5 gap-xl-11">
                ...
                <div class="row gap-4 gap-lg-0">
                    <div class="col-lg-4">
                        <h2 class="fs-13 mb-0" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
                            Cleaner Living, Healthier Spaces with Notale
                        </h2>
                    </div>
                    <div class="col-lg-8">
                        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                            <p class="fs-5 mb-6">
                                Notale is a rising home-appliance brand focused on delivering practical, efficient, and modern solutions for cleaner and healthier living.
                                Through Gadgetnio, Notale’s range of vacuum cleaners, dehumidifiers, and air purifiers is now accessible across Indonesia—helping households
                                create fresher, more comfortable, and dust-free environments every day.
                            </p>

                            <h4>1. Modern Appliances for a Cleaner Lifestyle</h4>
                            <p class="fs-5 mb-6">
                                From powerful vacuum cleaners designed for deep cleaning, to dehumidifiers that reduce excess moisture,
                                and air purifiers that improve indoor air quality—Notale brings smart, reliable home solutions that elevate
                                comfort and support healthier living.
                            </p>

                            <h4>2. Trusted Distribution, Nationwide Coverage</h4>
                            <p class="fs-5 mb-0">
                                With Gadgetnio’s strong distribution network, Notale products reach retailers and customers quickly and safely—ensuring
                                genuine quality, ready stock availability, and dependable after-sales support across Indonesia.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 mb-7" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                        <img src="../assets/images/portfolio/notale-product-1.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                        <img src="../assets/images/portfolio/notale-product-2.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                        <img src="../assets/images/portfolio/notale-product-3.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
