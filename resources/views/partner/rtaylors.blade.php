                ...
                <div class="d-flex flex-column gap-8">
                    ...
                    <div class="d-md-flex align-items-center gap-4 gap-lg-8" data-aos="fade-up" data-aos-delay="200"
                        ...
                        <div class="d-flex flex-column gap-2 py-2 pe-4 pe-lg-8 border-end">
                            ...
                            <p class="mb-0 text-dark fs-5 fw-medium">United Kingdom</p>
                        </div>
                        <div class="d-flex flex-column gap-2 py-2 pe-4 pe-lg-8 border-end">
                ...
                <div class="row gap-4 gap-lg-0">
                    <div class="col-lg-4">
                        <h2 class="fs-13 mb-0" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
                            Modern Home Living Made Simple with Russell Taylors
                        </h2>
                    </div>
                    <div class="col-lg-8">
                        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                            <p class="fs-5 mb-6">
                                Russell Taylors is a trusted home and lifestyle brand known for its practical, high-quality appliances
                                designed to elevate everyday living. Through Gadgetnio, Russell Taylors’ toasters, hair dryers, and body fat scales
                                are now accessible across Indonesia—bringing comfort, convenience, and reliable performance into modern households.
                            </p>

                            <h4>1. Smart Appliances for Better Daily Living</h4>
                            <p class="fs-5 mb-6">
                                From efficient toasters for quick breakfasts to powerful yet gentle hair dryers and accurate digital body fat scales,
                                Russell Taylors delivers products built for convenience and long-term use. Each appliance is crafted with thoughtful design,
                                dependable functionality, and user-centric features that support healthier and more efficient routines.
                            </p>

                            <h4>2. Reliable Distribution, Genuine Quality</h4>
                            <p class="fs-5 mb-0">
                                Supported by Gadgetnio’s nationwide distribution network, Russell Taylors products reach retailers and customers
                                quickly and securely—ensuring authentic quality, ready stock availability, and dependable after-sales support
