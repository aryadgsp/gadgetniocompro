                ...
                <div class="row gap-4 gap-lg-0">
                    <div class="col-lg-4">
                        <h2 class="fs-13 mb-0" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
                            Reliable Power & Protection with RAPA Tech
                        </h2>
                    </div>
                    <div class="col-lg-8">
                        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                            <p class="fs-5 mb-6">
                                RAPA Tech is a modern tech accessories brand committed to delivering dependable charging solutions
                                and premium device protection. Through Gadgetnio, RAPA Tech’s chargers, powerbanks, and tempered glass
                                are now accessible across Indonesia—offering practical, durable, and reliable essentials for everyday use.
                            </p>

                            <h4>1. Everyday Essentials Built for Performance</h4>
                            <p class="fs-5 mb-6">
                                From fast and stable chargers to long-lasting powerbanks and ultra-strong tempered glass,
                                RAPA Tech provides essential accessories designed to protect your devices and keep you powered throughout the day.
                                Each product combines efficiency, durability, and user-friendly design for a seamless digital experience.
                            </p>

                            <h4>2. Nationwide Reach, Authentic Quality</h4>
                            <p class="fs-5 mb-0">
                                With Gadgetnio’s extensive distribution network, RAPA Tech products reach retailers and customers quickly—ensuring
                                genuine quality, wide availability, and dependable after-sales support anywhere in Indonesia.
                            </p>
                        </div>
                    </div>
                </div>
