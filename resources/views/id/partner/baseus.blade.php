            ...
            <div class="d-flex flex-column gap-5 gap-xl-11">
                ...
                <div class="row gap-4 gap-lg-0">
                    <div class="col-lg-4">
                        <h2 class="fs-13 mb-0" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
                            Mendefinisikan Ulang Teknologi Sehari-hari bersama Baseus
                        </h2>
                    </div>
                    <div class="col-lg-8">
                        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                            <p class="fs-5 mb-6">
                                Baseus adalah brand teknologi gaya hidup global yang dikenal dengan desain modern,
                                fungsionalitas tinggi, dan komitmennya terhadap inovasi. Melalui Gadgetnio,
                                Baseus menghadirkan beragam aksesori premium—mulai dari kabel USB, earphone,
                                hingga TWS—lebih dekat kepada konsumen dan pelaku bisnis di seluruh Indonesia,
                                memastikan kualitas dan gaya dalam setiap produknya.
                            </p>

                            <h4>1. Desain Cerdas, Performa Unggul</h4>
                            <p class="fs-5 mb-6">
                                Setiap produk Baseus dibuat untuk memberikan performa yang andal serta pengalaman penggunaan yang mulus.
                                Dari kabel fast-charging hingga perangkat audio berteknologi tinggi, seluruh aksesori Baseus menggabungkan
                                fungsi praktis dengan desain refined untuk kebutuhan sehari-hari.
                            </p>

                            <h4>2. Produk Asli, Akses di Seluruh Indonesia</h4>
                            <p class="fs-5 mb-0">
                                Didukung oleh jaringan distribusi terpercaya milik Gadgetnio, produk Baseus tersedia dengan mudah
                                di seluruh Indonesia—menawarkan kualitas asli, pengiriman cepat, serta layanan purna jual profesional.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12 mb-7" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                        <img src="../../assets/images/portfolio/baseus-product-1.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                        <img src="../../assets/images/portfolio/baseus-product-2.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                        <img src="../../assets/images/portfolio/baseus-product-3.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
