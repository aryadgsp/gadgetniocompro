            ...
            <div class="d-flex flex-column gap-5 gap-xl-11">
                ...
                <div class="row gap-4 gap-lg-0">
                    <div class="col-lg-4">
                        <h2 class="fs-13 mb-0" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">
                            Tingkatkan Perjalanan Kebugaran Anda bersama YESOUL
                        </h2>
                    </div>
                    ...
                    <div class="col-lg-8">
                        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                            ...
                            <p class="fs-5 mb-6">
                                YESOUL adalah brand smart fitness terkemuka yang dikenal melalui peralatan olahraga inovatif, terintegrasi aplikasi,
                                dan berfokus pada kebutuhan pengguna. Melalui kolaborasi kami, Gadgetnio menghadirkan treadmill premium, spinning bike,
                                dan peralatan home gym YESOUL kepada para pecinta kebugaran di seluruh Indonesia—membuat latihan berkualitas tinggi
                                menjadi lebih mudah diakses, lebih menarik, dan lebih efektif.
                            </p>

                            <h4>1. Peralatan Fitness Pintar untuk Performa Maksimal</h4>
                            <p class="fs-5 mb-6">
                                Mulai dari spinning bike imersif dengan pelacakan performa real-time hingga treadmill kompak dan senyap untuk latihan di rumah,
                                YESOUL menawarkan peralatan berteknologi tinggi yang meningkatkan setiap sesi latihan. Dengan konektivitas aplikasi yang intuitif,
                                program latihan terpandu, serta desain ergonomis, YESOUL membantu pengguna tetap termotivasi dan mencapai progres yang nyata.
                            </p>

                            <h4>2. Distribusi Terpercaya, Tersedia di Seluruh Indonesia</h4>
                            <p class="fs-5 mb-0">
                                Didukung oleh jaringan distribusi Gadgetnio yang andal, produk YESOUL menjangkau retailer dan konsumen dengan cepat dan aman.
                                Dengan jaminan keaslian, ketersediaan stok, dan layanan purna jual yang profesional, kami memastikan pelanggan di seluruh Indonesia
                                dapat menikmati performa dan ketahanan penuh dari peralatan kebugaran YESOUL yang asli.
                            </p>
                ...
                <div class="row">
                    <div class="col-12 mb-7" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                        <img src="../../assets/images/portfolio/yesoul-product-1.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                        <img src="../../assets/images/portfolio/yesoul-product-2.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                        <img src="../../assets/images/portfolio/yesoul-product-3.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
