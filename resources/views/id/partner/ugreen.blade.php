        ...
        <div class="container position-relative z-2">
            <div class="d-flex flex-column gap-4 pb-5 pb-xl-10">
                ...
                <div class="d-flex align-items-end gap-3" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                    <h1 class="mb-0 fs-16 text-white lh-1">UGREEN</h1>
                    <a href="https://ugreen.com/" class="p-1 ps-7 bg-primary rounded-pill">
            ...
            <div class="d-flex flex-column gap-5 gap-xl-11">
                    ...
                    <div class="d-md-flex align-items-center gap-4 gap-lg-8" data-aos="fade-up" data-aos-delay="200"
                        ...
                        <div class="d-flex flex-column gap-2 py-2">
                            ...
                            <p class="mb-0 fs-5 fw-medium">
                                <a href="https://www.ugreen.com" target="_blank" class="text-dark text-decoration-none link-hover">
                                    ugreen.com
                                </a>
                            </p>
                        </div>
                ...
                <div class="row gap-4 gap-lg-0">
                    ...
                    <div class="col-lg-8">
                        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                            <p class="fs-5 mb-6">
                                UGREEN adalah pemimpin global dalam elektronik konsumen dan aksesori berkualitas tinggi, yang berkomitmen menghadirkan teknologi yang sederhana, andal, dan mudah diakses. Melalui kemitraan ini, Gadgetnio membantu UGREEN membawa solusi konektivitas terkini lebih dekat kepada pelaku bisnis dan konsumen di seluruh Indonesia.
                            </p>
                            <h4>1. Teknologi Inovatif untuk Kebutuhan Sehari-hari</h4>
                            <p class="fs-5 mb-6">
                                Dari kabel fast charging hingga smart hub dan perangkat audio,
                                produk UGREEN dirancang untuk meningkatkan produktivitas dan kenyamanan
                                melalui inovasi yang sesuai dengan gaya hidup modern.
                            </p>
                            <h4>2. Distribusi Terpercaya dengan Jangkauan Nasional</h4>
                            <p class="fs-5 mb-0">
                                Dengan jaringan distribusi Gadgetnio yang efisien, produk UGREEN
                                dapat menjangkau retailer dan pelanggan dengan cepat,
                                memastikan ketersediaan produk serta dukungan purnajual yang maksimal.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 mb-7" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                        <img src="../../assets/images/portfolio/ugreen-product-1.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                        <img src="../../assets/images/portfolio/ugreen-product-2.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                    <div class="col-lg-6 mb-7" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                        <img src="../../assets/images/portfolio/ugreen-product-3.jpg" alt="services" class="w-100 object-fit-cover">
                    </div>
                </div>
            </div>
        </div>
