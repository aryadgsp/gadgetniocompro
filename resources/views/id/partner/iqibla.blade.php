        ...
        <div class="container">
            <div class="d-flex flex-column gap-5 gap-xl-11">
                <div class="d-flex flex-column gap-8">
                    ...
                    <div class="d-md-flex align-items-center gap-4 gap-lg-8" data-aos="fade-up" data-aos-delay="200"
                        ...
                        <div class="d-flex flex-column gap-2 py-2 pe-4 pe-lg-8 border-end">
                            ...
                            <p class="mb-0 text-dark fs-5 fw-medium">Zikir Rings</p>
                        </div>
                ...
                <div class="row gap-4 gap-lg-0">
                    <div class="col-lg-4">
                        <h2 class="fs-13 mb-0" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">Menghadirkan Konektivitas Terbaik bersama UGREEN
                        </h2>
                    </div>
                    <div class="col-lg-8">
                        <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                            ...
                            <p class="fs-5 mb-6">
                                IQibla adalah brand teknologi gaya hidup Islami yang menghadirkan perangkat pintar untuk membantu umat Muslim
                                tetap terhubung secara spiritual kapan pun dan di mana pun. Melalui Gadgetnio, Zikr Ring dari IQibla kini
                                tersedia luas di seluruh Indonesia—menawarkan kemudahan, presisi, serta dukungan bermakna untuk ibadah harian.
                            </p>

                            <h4>1. Perangkat Pintar untuk Memperkuat Ibadah Sehari-hari</h4>
                            <p class="fs-5 mb-6">
                                Didesain nyaman, akurat, dan mudah digunakan, Zikr Ring membantu pengguna menghitung dzikir harian, memantau
                                waktu salat, dan tetap mengingat Allah sepanjang hari. Dengan desain yang elegan, fitur tasbih digital,
                                serta fungsi pintar yang intuitif, Zikr Ring mendukung pengalaman ibadah yang lebih fokus dan konsisten.
                            </p>

                            <h4>2. Distribusi Terpercaya, Produk Ibadah Pintar Bergaransi Asli</h4>
                            <p class="fs-5 mb-0">
                                Melalui jaringan distribusi Gadgetnio yang luas dan efisien, produk IQibla dapat menjangkau retailer dan
                                konsumen dengan cepat dan aman—menjamin keaslian produk, ketersediaan stok yang stabil, serta dukungan
                                purnajual yang dapat diandalkan. Gadgetnio membantu menghadirkan teknologi bermakna dari IQibla untuk umat
                                Muslim di seluruh Indonesia dengan nyaman dan penuh keyakinan.
                            </p>
