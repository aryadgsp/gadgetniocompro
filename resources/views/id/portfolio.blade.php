                    ...
                    <div class="col-xl-4">
                        <div class="d-flex align-items-center gap-4" data-aos="fade-up" data-aos-delay="100"
                            ...
                            <p class="mb-0 text-white fs-5 text-opacity-70">
                                ...
                                Distributor elektronik dan gadget terpercaya, menghubungkan brand kelas dunia dengan pasar Indonesia.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section class="project py-5 py-lg-11 py-xl-12">
        <div class="container">
            <div class="text-center mb-8" data-aos="fade-up" data-aos-delay="50" data-aos-duration="800">
                ...
                <h2 class="fw-bold mb-0">Dipercaya oleh Merek Terkemuka</h2>
            </div>
